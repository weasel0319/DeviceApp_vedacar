...
## 주요 기술 스택
- **언어**: C (C11)
- **멀티 스레딩**: POSIX Threads (Pthreads), Semaphore (동기화)
- **통신, 검증**: TCP/IP 소켓 프로그래밍, CRC16 CCITT
- **영상 스트리밍**: RTSP (Real-Time Streaming Protocol)
- **서비스 등록 및 네트워크**: systempd service, NetworkManager
- **필요 하드웨어, 라이브러리**: Raspberry Pi 4, Logitech HD Webcam, GStreamer Library
## 설치 방법
